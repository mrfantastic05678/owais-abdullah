  ...
  return (
    <section className="max-w-7xl mx-auto text-gray-600 body-font scroll-smooth">
      ...
      >
        ...
        >
          <p className="text-base text-center md:text-left text-accent font-medium sm:text-lg">
            About Me
          </p>
