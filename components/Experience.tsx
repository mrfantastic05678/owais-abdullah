...
const experienceData = [
...

  {
    ...
    content: (
      <div>
        ...
        <p className="text-sm text-neutral-400">OneKlick Digital Co.</p>
        <p className="text-neutral-200 text-xs md:text-sm font-normal mt-2">
  ...
  },
  {
    ...
    content: (
      <div>
        <h3 className="text-xl font-bold">Social Media Marketing Intern</h3>
        <p className="text-sm text-neutral-400">Marksman Advertising</p>
        <p className="text-neutral-200 text-xs md:text-sm font-normal mt-2">
  ...
  },
  {
    ...
    content: (
      <div>
        <h3 className="text-xl font-bold">Freelance Graphic Designer</h3>
        <p className="text-sm text-neutral-400">Fiverr</p>
        <p className="text-neutral-200 text-xs md:text-sm font-normal mt-2">
