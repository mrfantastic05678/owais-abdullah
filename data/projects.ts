const projects = {
  ...
  "Tools & Automation": [
    {
      ...
      description:
        "Tool for generating AI-powered social media content with Youtube videos.",
    ...
    },
    {
      ...
      description:
        "Tool that helps users transform, clean, Filter, visualize data (CSV/Excel), and give AI-Powered Suggestions.",
    ...
    },
    {
      ...
      description:
        "Tool to convert Units and currency with real time data using AI.",
  ...
  "HTML & CSS": [
    {
      ...
      description:
        "A custom resume-building tool with PDF export functionality.",
  ...
  // "Social Media & SEO": [
  //   {
  //     title: "Facebook Ad Optimization Tool",
  //     description:
  //       "An AI-powered tool that analyzes ad performance and suggests improvements.",
  //     image: "/assets/placeholder.png",
  //     link: "#",
  //     tags: ["AI", "Facebook Ads", "Marketing"],
  //   },
  //   {
  //     title: "Social Media Dashboard",
  //     description:
  //       "A unified dashboard for managing multiple social media accounts.",
  //     image: "/assets/placeholder.png",
  //     link: "#",
  //     tags: ["Dashboard", "Social Media", "Automation"],
  //   },
  // ],
};
