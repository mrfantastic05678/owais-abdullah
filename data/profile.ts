...
export const profile = {
  ...
  summary:
    "I build production-ready web applications and AI agents using spec-driven development and AI-driven engineering. Specializing in Next.js SaaS products, Digital FTEs (AI employees that handle business operations 24/7), and intelligent automation that scales with businesses. Expert in TypeScript, OpenAI Agents SDK, and building robust architectures from the ground up.",
