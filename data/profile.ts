...
// (server-rendered projects), the Experience timeline, and the curated Stack.
...
const existingProjects: Project[] = [
  ...
  },
  {
    ...
    repoUrl: "https://github.com/MrOwaisAbdullah/Teamflow",
    slug: "teamflow",
    category: "Platform",
  ...
  },
  {
    ...
    repoUrl: "https://github.com/MrOwaisAbdullah/visati",
    slug: "visati",
    category: "Platform",
  ...
  },
  {
    ...
    repoUrl: "https://github.com/MrOwaisAbdullah/Furniture-Site",
    slug: "yousuf-living",
    category: "Ecommerce",
  ...
  },
  {
    ...
    repoUrl: "https://github.com/MrOwaisAbdullah/rentparlo",
    slug: "rentparlo",
  ...
  },
  {
    ...
    link: "https://github.com/MrOwaisAbdullah/Digital-FTE",
    repoUrl: "https://github.com/MrOwaisAbdullah/Digital-FTE",
    slug: "digital-fte",
...

  {
    ...
    image: "/assets/projects/shopmate-fte.png",
    link: "https://shopmate.octively.com",
    repoUrl: "https://github.com/MrOwaisAbdullah/Shopmate-fte",
    slug: "shopmate-fte",
    category: "Digital FTE",
    tags: ["Shopify", "AI Agents", "Automation", "SaaS", "Digital FTE"],
    techStack: ["Python", "PostgreSQL", "MCP", "Shopify API", "OpenAI Agents SDK"],
  },
  {
  ...
  {
    title: "ScrollFX Studio",
    description: "WordPress plugin that converts uploaded videos into smooth, Apple-style scroll-scrubbed canvas heroes. Features client-side frame extraction, Gutenberg block, Elementor widget, and 5 curated presets.",
    image: "/assets/placeholder.png",
    link: "https://github.com/MrOwaisAbdullah/wp-plugins",
    repoUrl: "https://github.com/MrOwaisAbdullah/wp-plugins",
    category: "WordPress",
    tags: ["WordPress", "Plugin", "Canvas API", "Gutenberg", "Elementor", "Scroll Animation"],
    techStack: ["WordPress", "PHP", "JavaScript", "HTML5 Canvas", "Gutenberg", "Elementor"],
  },
  // Tools & Automation
  {
  ...
  {
    title: "Owais Content Factory",
    description: "AI-powered video production pipeline that transforms raw talking-head footage into polished YouTube videos with programmatic Remotion TSX overlays, synthetic screen recordings, voice isolation, sound design, and automated uploads.",
    image: "/assets/projects/content-factory.png",
    link: "https://github.com/MrOwaisAbdullah/owais-content-factory",
    repoUrl: "https://github.com/MrOwaisAbdullah/owais-content-factory",
    category: "AI Tool",
    tags: ["Remotion", "React", "Python", "FastAPI", "AI Video", "Automation"],
    techStack: ["Python", "FastAPI", "Remotion", "React", "TypeScript", "OpenAI Agents SDK", "AssemblyAI", "ElevenLabs API", "FFmpeg"],
  },
  {
    title: "Claude Faceless Shorts Creator",
    description: "Faceless YouTube Shorts factory driven via Claude Code across three automated production tracks: pure Remotion TSX code compositions, generative AI character animation with Fal, and Vox-style documentary collage.",
    image: "/assets/placeholder.png",
    link: "https://github.com/MrOwaisAbdullah/claude-faceless-shorts-creator",
    repoUrl: "https://github.com/MrOwaisAbdullah/claude-faceless-shorts-creator",
    category: "AI Tool",
    tags: ["Claude Code", "AI Video", "Remotion", "YouTube Shorts", "Automation"],
    techStack: ["TypeScript", "React", "Remotion", "Claude Code", "ElevenLabs API", "Fal AI", "Node.js"],
  },
  {
    title: "Shopify MCP Connector",
    description: "Production-grade Model Context Protocol (MCP) server connecting AI agents to Shopify stores — multi-store OAuth 2.1, pluggable PostgreSQL token storage, and 79+ gated tools across orders, inventory, and operations.",
    image: "/assets/placeholder.png",
    link: "https://github.com/MrOwaisAbdullah/shopify-multistore-mcp",
    repoUrl: "https://github.com/MrOwaisAbdullah/shopify-multistore-mcp",
    category: "Tool",
    tags: ["MCP", "Shopify", "AI Agents", "TypeScript", "GraphQL", "E-commerce"],
    techStack: ["TypeScript", "Node.js", "Model Context Protocol (MCP)", "Shopify Admin API", "GraphQL", "PostgreSQL", "Express"],
  },
  {
    title: "Octively Growth Automation",
    description: "Automated client acquisition toolkit for Octively — discovers agency/freelancer prospects via Tavily, drafts personalized cold outreach messages, and researches trending topics with maker-checker verification.",
    image: "/assets/placeholder.png",
    link: "#",
    category: "AI Tool",
    tags: ["AI Automation", "Lead Generation", "Outreach", "Growth Engineering", "Python"],
    techStack: ["Python", "Tavily API", "Obsidian Vault", "Puppeteer", "Node.js", "OpenAI API"],
  },
];
...
const githubRepositories: Project[] = [
  ...
  },
  {
    ...
    category: "Digital FTE",
    description:
      "Autonomous AI Content Employee (Digital FTE) that researches search queries, writes, and publishes 15–17 SEO articles daily to Sanity with adapters for WordPress, Shopify, Wix, and Headless CMS.",
    link: "https://github.com/MrOwaisAbdullah/ContentFTE",
    repoUrl: "https://github.com/MrOwaisAbdullah/ContentFTE",
    slug: "contentfte",
    deployedUrl: null,
    image: "/assets/projects/seo-blog-agent.png",
    techStack: ["Python", "OpenAI Agents SDK", "Sanity CMS", "Cloudflare Workers AI", "Tavily API"],
    tags: ["Python", "Digital FTE", "AI Employee", "SEO", "Content Automation"],
    stars: 0,
    language: "Python",
  },
  {
    ...
    category: "Digital FTE",
    description:
      "Autonomous AI Social Media FTE — runs brand social accounts end to end: drafts captions in brand voice, renders Remotion video shorts, waits for Discord approvals, then publishes across Facebook, Instagram, YouTube Shorts, and TikTok.",
    link: "https://github.com/MrOwaisAbdullah/socialfte",
    repoUrl: "https://github.com/MrOwaisAbdullah/socialfte",
    slug: "socialfte",
    deployedUrl: null,
    image: "/assets/projects/social-fte.png",
    techStack: ["Next.js 16", "Python", "Remotion", "Cloudflare R2", "Discord", "FFmpeg"],
    tags: ["Next.js", "Python", "Digital FTE", "AI Employee", "Remotion", "Video Automation"],
    stars: 0,
    language: "Python",
  },
  {
  ...
  },
  {
    ...
    category: "Institution",
    description:
      "Global online Quran education academy platform connecting students with certified male and female tutors for 1-on-1 live interactive classes.",
    link: "https://voiceofholyquran.com/",
    repoUrl: "https://github.com/MrOwaisAbdullah/Voice-Of-Holy-Quran",
    slug: "voice-of-holy-quran",
    deployedUrl: "https://voiceofholyquran.com/",
    image: "/assets/projects/vhq.png",
    techStack: ["Next.js 14/15", "TypeScript", "Tailwind CSS", "Audio Streaming API"],
    tags: ["Next.js", "Education", "Islamic Academy", "Online Learning"],
    stars: 0,
    language: "TypeScript",
  },
];
...
export const stack: CuratedStackProfile = {
  ...
  essentialTools: [
    {
      ...
      projectsUsingIt: ["ShopMate", "Octively", "Digital FTE"],
    },
    {
      ...
      rating: 5,
      tagline: "Official framework for building multi-agent systems and Digital FTEs.",
      projectsUsingIt: ["ShopMate", "Octively", "Digital FTE"],
    },
    {
      name: "Claude Code",
      category: "dev-tool",
      stackLayer: "Dev Environment & Agents",
      rating: 5,
      tagline: "Agentic coding CLI and autonomous agent runtime.",
      projectsUsingIt: ["Digital FTE"],
    },
    {
      name: "LiteLLM",
      category: "router",
      ...
      rating: 5,
      tagline: "Universal proxy to call 100+ LLMs in OpenAI format with load balancing.",
      projectsUsingIt: ["ShopMate", "Octively"],
    },
    {
      name: "Drizzle ORM",
      category: "infra",
      stackLayer: "Database Layer",
      rating: 5,
      tagline: "TypeScript ORM with zero overhead and maximum type safety.",
      projectsUsingIt: ["ShopMate", "Octively", "Visati"],
    },
    {
      name: "Cloudflare R2",
      category: "infra",
      ...
      rating: 5,
      tagline: "S3-compatible zero-egress fee object storage.",
      projectsUsingIt: ["ShopMate", "Octively"],
    },
  ],
};
